#define NGX_CONFIGURE " --prefix=/home/rench/nginx-v1.11.2.1 --with-openssl=/usr/local/openssl-0.9.8zf --with-zlib=/usr/local/zlib-1.2.8 --with-pcre=/usr/local/pcre-8.37 --with-debug"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/rench/nginx-v1.11.2.1/"
#endif
