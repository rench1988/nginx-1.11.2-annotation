...
ngx_http_init_connection(ngx_connection_t *c)
{
    ...
    c->log_error = NGX_ERROR_INFO;   //NGX_ERROR_INFO是什么意思?(发生错误时输出INFO日志?)
...
ngx_http_close_connection(ngx_connection_t *c)
{
    ...
    ngx_close_connection(c);  //所有相关事件都删除,关闭套接字,connection归还free_connection队列
