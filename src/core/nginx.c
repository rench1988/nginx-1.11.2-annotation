...
main(int argc, char *const *argv)
{
    ...
    /* TODO */ ngx_max_sockets = -1; //在ngx_posix_init.c里面定义
    ...
    init_cycle.log = log;
    ngx_cycle = &init_cycle;   //ngx_cycle在ngx_cycle.c中定义,为全局变量
